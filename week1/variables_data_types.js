...
/** Пару слов о правилах наименовавния переменных  в javascript 
 ...
 * Зарезервированными именами являются основные конструкции языка. Например let, const, var с помощью которых мы создаем переменные
 * Или слова function который создает функцию
 * 
